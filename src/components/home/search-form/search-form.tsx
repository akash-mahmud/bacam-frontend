...
export default function FindTripForm() {
  ...
  return (
    <form
      ...
      className="relative z-[2] w-full max-w-[450px] rounded-lg bg-white p-6 2xl sm:m-0 sm:max-w-[380px] sm:p-7 sm:pt-9 md:max-w-[400px] md:none lg:rounded-xl xl:max-w-[460px] xl:p-9 4xl:max-w-[516px] 4xl:p-12"
    >
