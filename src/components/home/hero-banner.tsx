...
const avatarData = [
  ...
  },
  {
    ...
    longitude: 12.2,
    image:
      'https://raw.githubusercontent.com/mallowigi/a-file-icon-idea/master/icon.png',
  },
...
export default function HeroBanner() {
  ...
  const handleMapChange = (event: GoogleMapReact.ChangeEventValue) => {
    ...
    const newMapType =
      zoom >= 14 ? 'hybrid' : zoom >= 12 ? 'terrain' : 'roadmap';
  ...
  return (
    <>
      ...
      {isLoaded ? (
        <GoogleMap
          mapContainerClassName="aspect-[2/1] h-80 bg-gray-lighter object-cover mt-24"
          // onLoad={(map) => {
