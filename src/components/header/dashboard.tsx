...
export default function DashboardHeader() {
  ...
  return (
    <header
      // ref={headerRef}
      className="dashboard-header is-scrolling sticky top-0 z-50 flex h-16 w-full b b-gray-lighter bg-white md:flex md:items-center lg:h-[72px] 2xl:h-20 4xl:h-24"
    >
