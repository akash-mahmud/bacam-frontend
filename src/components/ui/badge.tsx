  ...
  variant: {
    ...
    outline: {
      ...
      color: {
        ...
        primary: 'primary text-primary-dark',
        secondary: 'secondary text-secondary-dark',
        success: 'green text-green-dark',
        warning: 'orange text-orange-dark',
        danger: 'red text-red-dark',
        info: 'blue text-blue-dark',
      },
    },
  },
};
