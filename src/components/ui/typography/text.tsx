...
const classes = {
  ...
  mark: '',
  abbr: 'cursor-help',
  pre: '2 gray-300 py-3 px-4 rounded-xl bg-gray-100',
  code: '-gray-300 py-2 px-3 rounded-md ""',
  kbd: 'bg-gray-100 -gray-300 text-gray-900 rounded-lg leading-none inline-flex items-center justify-center text-sm py-1.5 px-2',
  blockquote: 'l-4 gray-300 text-quote py-3 px-4',
  sub: '',
  sup: '',
};
